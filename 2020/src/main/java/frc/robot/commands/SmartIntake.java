...
public class SmartIntake extends ParallelCommandGroup {
  ...
  public SmartIntake(double feedSpeed, double stirSpeed, Intaker intaker, Feeder feeder, Stirrer stirrer) {
    m_feeder = feeder;
    m_intaker = intaker;
    m_stirrer = stirrer;
    ...
    addCommands(
      ...
      new ParallelCommandGroup(new Stir(m_stirSpeed, m_stirrer),
