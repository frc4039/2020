...
public class StealAutoClose extends SequentialCommandGroup {
  static final Trajectory farTrajectory1 = TrajectoryGenerator.generateTrajectory(
      ...
      List.of(new Translation2d(Units.inchesToMeters(42), Units.inchesToMeters(18))),
      // End 3 meters straight ahead of where we started, facing forward
      new Pose2d(Units.inchesToMeters(98), Units.inchesToMeters(3), new Rotation2d(-Units.degreesToRadians(30))),
      // Pass config
